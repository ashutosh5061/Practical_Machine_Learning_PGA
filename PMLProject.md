...
![](PMLProject_files/figure-html/unnamed-chunk-13-1.png)<!-- -->
...
![](PMLProject_files/figure-html/unnamed-chunk-14-1.png)<!-- -->

```r
plot(mod_rf)
```

![](PMLProject_files/figure-html/unnamed-chunk-14-2.png)<!-- -->

```r
plot(mod_gbm)
```

![](PMLProject_files/figure-html/unnamed-chunk-14-3.png)<!-- -->
